...
var banana_btn = document.getElementById("banana");
...
function showText2() {
    document.getElementById("text").innerHTML = "원숭이가 나타났어요!!";
}

// 3. 선택한 요소에 "click" 이벤트 핸들러를 등록하세요. (이벤트명: "click", 함수이름)
carrot_btn.addEventListener("click", showText1);
banana_btn.addEventListener("click", showText2);